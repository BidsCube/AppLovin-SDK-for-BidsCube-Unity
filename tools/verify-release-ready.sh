...
if deps.get("com.bidscube.sdk") != "1.2.6":
    raise SystemExit(
        "ERROR: package.json must depend on com.bidscube.sdk 1.2.6 exactly "
...
print("package.json peer dependency OK: com.bidscube.sdk 1.2.6 only")
PY
