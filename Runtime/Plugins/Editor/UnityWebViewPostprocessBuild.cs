...
#endif
{
    ...
    public void OnPreprocessBuild(BuildTarget buildTarget, string path) {
        if (buildTarget == BuildTarget.Android) {
            string dev = null, rel = null;
            var candidates = new[] {
                "Packages/com.bidscube.sdk/Runtime/Plugins/Android/WebViewPlugin-development.aar.tmpl",
                "Packages/com.bidscube.sdk/Runtime/Plugins/Android/WebViewPlugin-release.aar.tmpl",
                "Packages/net.gree.unity-webview/Assets/Plugins/Android/WebViewPlugin-development.aar.tmpl",
                "Packages/net.gree.unity-webview/Assets/Plugins/Android/WebViewPlugin-release.aar.tmpl",
                "Assets/Plugins/Android/WebViewPlugin-development.aar.tmpl",
                "Assets/Plugins/Android/WebViewPlugin-release.aar.tmpl",
            };
            for (int i = 0; i < candidates.Length; i += 2) {
                if (File.Exists(candidates[i]) && File.Exists(candidates[i + 1])) {
                    dev = candidates[i];
                    rel = candidates[i + 1];
                    break;
                }
            ...
            if (dev == null || rel == null) {
                UnityEngine.Debug.LogError("[BidscubeSDK] WebView: Could not find WebViewPlugin-*.aar.tmpl in Packages/com.bidscube.sdk, Packages/net.gree.unity-webview, or Assets/Plugins/Android.");
                return;
            }
