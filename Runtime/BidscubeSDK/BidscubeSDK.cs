...
namespace BidscubeSDK
{
    ...
    public class BidscubeSDK : MonoBehaviour
    {
        ...
        /// <summary>Last configuration passed to <see cref="Initialize(SDKConfig)"/>; used to sync native Android Bidscube SDK.</summary>
        internal static SDKConfig ActiveConfiguration => _configuration;
        ...
        private static void LogInitPublisherRow(SDKConfig config)
        {
            ...
            var row =
                $"Init (publisher row): unityUPM={Constants.SdkVersion} gradleCore=com.bidscube:bidscube-sdk:{Constants.NativeAndroidBidscubeSdkVersion}@aar " +
        ...
        /// <summary>
        /// In <see cref="BidscubeIntegrationMode.AppLovinMaxMediation"/>, Unity must not attach Bidscube creatives from C#; MAX loads via the native adapter.
        /// </summary>
        private static void AssertDirectSdkForCreativeApis(string apiName)
        {
            if (_configuration != null && _configuration.IntegrationMode.IsMediationMode())
            {
        ...
        public static void ShowImageAd(string placementId, IAdCallback callback = null)
        {
            ...
            AssertDirectSdkForCreativeApis(nameof(ShowImageAd));
        ...
        {
            AssertDirectSdkForCreativeApis(nameof(GetBannerAdView));
        ...
        public static void ShowNativeAd(string placementId, IAdCallback callback = null)
        {
            ...
            AssertDirectSdkForCreativeApis(nameof(ShowNativeAd));
        ...
        {
            AssertDirectSdkForCreativeApis(nameof(GetNativeAdView));
