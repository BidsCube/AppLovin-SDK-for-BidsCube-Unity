...
5. Optionally pin: `https://github.com/BidsCube/AppLovin-SDK-for-BidsCube-Unity.git#v1.0.15`
6. Click `Add`
...
```json
{
  "dependencies": {
    ...
    "com.bidscube.applovin.max": "https://github.com/BidsCube/AppLovin-SDK-for-BidsCube-Unity.git#v1.0.15"
  }
}
```
